...
/datum/map/blackstone
	name = "Unnamed Mountain"
	full_name = "Unnamed Mountains"
	path = "blackstone"
	...
	zlevel_datum_type = /datum/map_z_level/blackstone
...
/datum/map_z_level/blackstone/station
...
/datum/map/blackstone/perform_map_generation()
/*
